...
<div id="staff_work">
  ...
  <form action="new_user.php" method="post">
    <table>
      ...
      <tr>
        <td colspan="2"><center>
          <input type="submit" name="submit" value="Create user" id="submit" /></td>
      </tr>
    </table>
  </form>
  </td>
  ...
  <div id="staff_content"> <br/>
    ...
    <?php
		...
		while ($advertisements_set = mysql_fetch_array($advertisements)) {
			echo "<table>";
			echo "<tr><td width=\"40\">id:  " . $advertisements_set['id']."</td><td>";			
			echo "Username: " . $advertisements_set['username']."</td></tr></table>";
		}
	?>
  </div>
