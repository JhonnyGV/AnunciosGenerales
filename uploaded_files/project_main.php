...
<div id="navigation">
	<a href="staff.php">Return to staff section</a>
	...
	<table cellpadding="5">
		...
		<tr>
			...
			<td><input type="number" name="min_area" placeholder="Min. Area">&nbsp;-&nbsp;
				<input type="number" name="max_area" placeholder="Max. area"> Sq. ft.</td>
		</tr>
		<tr>
...
<!--	<p>
	...
	<hr size="5">
	<center>
		<input type="submit" name="submit" value="Submit Property" id="submit"></center>
</div>
<!--<div id="ads">
	<center>
